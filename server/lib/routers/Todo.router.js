...
_get__('router').get('/', _get__('todoController').getTodos);
_get__('router').post('/', _get__('todoController').postTodo);
_get__('router').patch('/:id', _get__('todoController').patchTodo);
_get__('router').delete('/:id', _get__('todoController').deleteTodo);
...
function _get_original__(variableName) {
  switch (variableName) {
    ...
    case 'todoController':
      return _filterWildcardImport__(todoController);
  }
